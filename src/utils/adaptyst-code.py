...
paths_file_help = \
    'path to a code paths file generated by Adaptyst\n' \
...
def run(paths_file, output, verbose):
    ...
    if paths_file == '-':
        ...
        if not p.exists():
            print('adaptyst-code: error: ' + paths_file + ' does not exist',
                  file=sys.stderr)
            return 1
        elif p.is_dir():
            print('adaptyst-code: error: ' + paths_file + ' is a directory',
                  file=sys.stderr)
            return 1
...
if __name__ == '__main__':
    ...
    try:
        ...
        print('adaptyst-code: Interrupted', file=sys.stderr)
